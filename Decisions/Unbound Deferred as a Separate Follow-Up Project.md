...
Deferred, not rejected. Planned as a deliberate future project once the core Pi-hole setup is proven stable and the network-wide DNS switch (see [Pi-hole](../Projects/Pi-hole.md)) is confirmed working.
